...
$length   = checkVar($_POST['length'])? $_POST['length']:false;
$angle    = checkVar($_POST['angle'])? $_POST['angle']:false;
$depth    = checkVar($_POST['depth'])? $_POST['depth']:false;
$branches = checkVar($_POST['branches'])? $_POST['branches']:false;
